...
The `rx-*` documentation update is aligned with `MahmoudAbdalrhmanMohamed/resux` branch `feat/rx-directive-branding` at verified commit `4248f55b54066c143d4e619fc15383d422c43d6e` and pull request `#9`.
