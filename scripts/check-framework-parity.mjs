...
const expectedDestinations = new Map([
  ...
  [`${packageName}/runtime/core`, 'docs/reference/runtime.md'],
  [`${packageName}/runtime/router`, 'docs/reference/runtime.md'],
  [`${packageName}/runtime/reactivity`, 'docs/reference/reactivity.md'],
  [`${packageName}/runtime/resume`, 'docs/reference/runtime.md'],
  [`${packageName}/runtime/streaming`, 'docs/reference/runtime.md'],
  [`${packageName}/reactivity`, 'docs/reference/reactivity.md'],
  [`${packageName}/compiler`, 'docs/reference/compiler.md'],
  [`${packageName}/build`, 'docs/reference/compiler.md'],
